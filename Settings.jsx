        ...
        <TextInput
          ...
          onChange={(serverid) => {
            ...
            if (/^[0-9]{18}$/m.test(serverid)) {
              createPromptModal("Would you like VERIFIED, PARTNERED, or NONE?").then(feature => feature.toUpperCase().trim()).then(feature => {
                if (feature === 'VERIFIED' || feature === 'PARTNERED' || feature === 'NONE') {
